const PRODUCTS=[
 {id:'autocad-2024',name:'AutoCAD 2024',cat:'cad',label:'CAD',accent:'#e73b4d',logo:'assets/products/autocad.png',desc:'2D and 3D CAD design and drafting service.',features:['Product selection: AutoCAD 2024','Engineering and drafting workflow','Technical support route available']},
 {id:'autocad-2025',name:'AutoCAD 2025',cat:'cad',label:'CAD',accent:'#d42b41',logo:'assets/products/autocad.png',desc:'CAD design and drafting service for professional workflows.',features:['Product selection: AutoCAD 2025','2D and 3D design workflow','Technical support route available']},
 {id:'autocad-2027',name:'AutoCAD 2027',cat:'cad',label:'CAD',accent:'#e54a56',logo:'assets/products/autocad.png',desc:'Current-generation CAD workflow option in the Techies Lab collection.',features:['Product selection: AutoCAD 2027','Engineering and design workflow','Technical support route available']},
 {id:'electrical-2024',name:'AutoCAD Electrical 2024',cat:'electrical',label:'ELEC',accent:'#f05a3f',logo:'assets/products/autocad-electrical.png',desc:'Electrical design workflow for schematic and control-system projects.',features:['Product selection: AutoCAD Electrical 2024','Electrical engineering workflow','Technical support route available']},
 {id:'electrical-2026',name:'AutoCAD Electrical 2026',cat:'electrical',label:'ELEC',accent:'#ff7a34',logo:'assets/products/autocad-electrical.png',desc:'Electrical design workflow for engineering documentation and projects.',features:['Product selection: AutoCAD Electrical 2026','Electrical engineering workflow','Technical support route available']},
 {id:'architecture-2024',name:'AutoCAD Architecture 2024',cat:'architecture',label:'ARCH',accent:'#8d4ed7',logo:'assets/products/autocad-architecture.png',desc:'Architecture-focused drafting and design workflow.',features:['Product selection: AutoCAD Architecture 2024','Architectural drafting workflow','Technical support route available']},
 {id:'mep-2024',name:'AutoCAD MEP 2024',cat:'engineering',label:'MEP',accent:'#1a9f7c',logo:'assets/products/autocad-mep.png',desc:'Mechanical, electrical and plumbing design workflow.',features:['Product selection: AutoCAD MEP 2024','MEP engineering workflow','Technical support route available']},
 {id:'nastran-2025',name:'AutoCAD Inventor Nastran 2025',cat:'engineering',label:'NAS',accent:'#b45a1c',logo:'assets/products/inventor-nastran.png',desc:'Engineering analysis and simulation workflow selection.',features:['Product selection: AutoCAD Inventor Nastran 2025','Engineering analysis workflow','Technical support route available']}
];
...
function openInfo(p){selected=p;document.getElementById('modalBadge').outerHTML=productLogo(p,true).replace('class="modal-logo-stage"','class="modal-logo-stage" id="modalBadge"');document.getElementById('modalCategory').textContent=p.cat.toUpperCase();document.getElementById('modalTitle').textContent=p.name;document.getElementById('modalDescription').textContent=p.desc;document.getElementById('modalFeatures').innerHTML=p.features.map(x=>`<li>${x}</li>`).join('');modal.classList.add('open');modal.setAttribute('aria-hidden','false')}
